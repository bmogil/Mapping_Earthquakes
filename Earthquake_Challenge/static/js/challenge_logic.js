...
// We create the second tile layer that could be the background of our map.
...
// We create the third tile layer that could be the background of our map.
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(data) {
  ...
  // Adding majorEarthquakeData group layer to map.
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(data) {
    ...
    // Creating a GeoJSON layer for the retrieved data.
    L.geoJson(data, {
      color: "#7FFF00",
      weight: 4,
